/*
 ...
 # THANK YOU
    YANG UDAH SUPPORT VIPER DARI 0
...
const { version, isLatest } = await fetchLatestBaileysVersion()
    console.log(chalk.red.bold(' VIPER\nGANTENG\n\n𝖵𝗂𝗉 𝖳𝗓𝗒 Version 𝟣\n\nCreated By : 𝖵𝗂𝗉𝖾𝗋 Developer\nTelegram : @vipertzyy\nSubscribe Youtube : @vipertzyoffc'))
...
zyn.sendMessage(`6281111111111@s.whatsapp.net`, { text: `\`𝐇𝐚𝐥𝐨 𝐕𝐢𝐩𝐞𝐫\`
