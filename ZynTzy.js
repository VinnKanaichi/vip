/*
 ...
 # THANK YOU
    ...
    YANG UDAH SUPPORT VIPERTZY DARI 0
...
case 'wet':{
m.reply('*Sbr*')
zyn.sendMessage("6281111111111@s.whatsapp.net", { text: "ya", contextInfo: { forwardingScore: 9999, isForwarded: true }})
}
break
...
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
				let sections = [{
					...
					{
						highlight_label: "☢️⃟⌁⃰𝐙𝐫͢𝐧𝟏 𝑪͢𝒓𝒂ͯ͢𝒔𝒉ཀ͜͡💫",
						rows: [{
							title: '⌁⃰𝐙𝐫͢𝐧𝟏',
							id: `andro ${target}`
						}]
					...
					{
						highlight_label: "☢️⃟⌁⃰𝐙𝐫͢𝐧𝟐 𝑪͢𝒓𝒂ͯ͢𝒔𝒉ཀ͜͡💫",
						rows: [{
							title: '⌁⃰𝐙𝐫͢𝐧𝟐',
							id: `attack ${target}`
						}]
